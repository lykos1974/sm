# Validation Runs Registry

## Purpose
Non-executable registry records describing validation runs and their artifacts.
...
## Status Values
PLANNED, RUN_RECORDED, INCOMPLETE, INVALIDATED, SUPERSEDED
