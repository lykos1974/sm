...
class Hypothesis:
    ...
    def __post_init__(self) -> None:
        ...
        _require_tuple(self.supporting_evidence_ids, "supporting_evidence_ids")

    def to_dict(self) -> dict[str, Any]:
        return {"id": self.id, "statement": self.statement, "supporting_evidence_ids": list(self.supporting_evidence_ids)}
