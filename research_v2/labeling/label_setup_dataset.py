...
def _base_label_row(setup_row: dict[str, Any], label_mode: str, source_dataset_artifact: str, source_manifest_path: str | None) -> dict[str, Any]:
    return {
        ...
        "trend_regime": setup_row.get("trend_regime"),
        "is_extended_move": setup_row.get("is_extended_move"),
        "active_leg_boxes": setup_row.get("active_leg_boxes"),
        "entry_distance_bucket": setup_row.get("entry_distance_bucket"),
        "continuation_execution_class": setup_row.get("continuation_execution_class"),
        "pattern_family": setup_row.get("pattern_family"),
        "is_baseline_profile_match": setup_row.get("is_baseline_profile_match"),
