    ...
    try:
        ...
        for row in rows:
            ...
            export_row = {
                ...
                "rr1": raw.get("rr1"),
                "rr2": raw.get("rr2"),
                "entry_distance_boxes": raw_setup.get("entry_distance_boxes"),
                "entry_distance_bucket": raw_setup.get("entry_distance_bucket"),
                "breakout_level": raw_setup.get("breakout_level"),
                "continuation_quality_score": raw_setup.get("continuation_quality_score"),
                "extension_penalty": raw_setup.get("extension_penalty"),
                "continuation_execution_class": raw_setup.get("continuation_execution_class"),
                "pattern_family": raw_setup.get("pattern_family"),
                "distance_policy_action": raw_setup.get("distance_policy_action"),
                "is_baseline_profile_match": raw_setup.get("is_baseline_profile_match"),
