...
class WindowsAuditUpdatePortabilityTests(TestCase):
    ...
    def test_discovery_source_is_canonical_and_stale_or_modified_bytes_are_rejected(self):
        ...
        self.assertNotEqual(expected, "6e92dbc101187d40b255d7c79a95fe03037fcc35e456502cbc318e5ccb8f021a")
        self.assertIn(b"if side in (2, 4):", payload)
        stale = payload.replace(b"if side in (2, 4):", b"if side not in (1, 3):\n            raise ValueError()")
